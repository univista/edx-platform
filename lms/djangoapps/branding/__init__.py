...
def get_visible_courses_search(request):
    ...
    filtered_by_org = microsite.get_value('course_org_filter')
    _courses = modulestore().get_courses(org=filtered_by_org,display_name=filtered_by_name)
...
def get_visible_courses_partner(request, app_id):
    filtered_by_org =  app_id

    _courses = modulestore().get_courses(org=filtered_by_org)
    #_courses = modulestore().get_courses_partner(org=filtered_by_org)
