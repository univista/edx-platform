...
def professor(request):
    return courseware.views.professor(request)

@ensure_csrf_cookie
@cache_if_anonymous()
def partner(request):
    return courseware.views.partner(request)
...
def course_readings(request):
    return courseware.views.course_readings(request)
...
def professor_sub(request):
    return courseware.views.professor_sub(request)
